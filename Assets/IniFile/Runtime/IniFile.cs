...
public class IniFile
{
    ...
    public Dictionary<string, Dictionary<string, string>> IniConfigDic { get; private set; }
    //初始化
    /// <summary>
    /// 初始化
    /// </summary>
    /// <param name="path">文件路径</param>
    /// <param name="isCaseSensitive">是否忽略大小写</param>
    public IniFile(string path, bool isCaseSensitive = false)
    {
        IniConfigDic = new Dictionary<string, Dictionary<string, string>>();
        strFilePath = path;
    ...
    public void AddBool(string section, string key, bool val)
    {
        AddString(section, key, val.ToString());
    }
    public void AddFloat(string section, string key, float val)
    {
        AddString(section, key, val.ToString());
    }
